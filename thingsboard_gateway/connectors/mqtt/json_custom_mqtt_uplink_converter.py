            ...
            for datatype in datatypes:
                ...
                for datatype_config in self.__config.get(datatype, []):
                    if isinstance(datatype_config, str) and datatype_config == "*":
                        ...
                        # Handle ${*} for full JSON payload
                        if datatype_config["value"] == "${*}":
                            values = [data]  # Use entire JSON payload
                            values_tags = ["*"]
                        else:
                        ...
                        for (value, value_tag) in zip(values, values_tags):
                            is_valid_value = "${" in datatype_config["value"] and "}" in datatype_config["value"] and value_tag != "*"
